...
Usamos uma chamada \Call{RetornaSubárvore}{$v$} que atravessa a árvore do nó \(v\) e retorna
...
%   \draw[gray!30] (-15,-12) grid[xstep=1, ystep=1]  (15,12);
  ...
  \draw[red] (-5,12)--(-5,-12); % y axis
  \draw[green] (-15,-1)--(-5,-1); % y axis
  \draw[green] (15,2)--(-5,2); % y axis
  \draw[blue] (-8,-1)--(-8,-12); % y axis
  \draw[blue] (-13,-1)--(-13,12); % y axis
  \draw[blue] (4,2)--(4,-12); % y axis
  \draw[blue] (2,2)--(2,12); % y axis
  
  \draw[orange] (-15,-7)--(-8,-7); % y axis
  \draw[orange] (4,-6)--(15,-6); % y axis
  
  \fill (-13,8)  circle[radius=2pt]node[anchor=north east]{(-13)};
  \fill (-8,6)  circle[radius=2pt] node[anchor=north east]{(-8)};
