...
Ao chegar no $nó_{-8}$, o $filho_{direita}$ é folha e está dentro da consulta e é retornado. 
E a área de $nó_{-7}$ tem a forma $-\infty \leq x < -8$, logo não intersecta a consulta. E portanto, 
não há mais descida nos nós filhos de $nó_{-8}$.

Quando chega no $nó_{-6}$, o $filho_{esquerda}$ é nó folha e não está na consulta, e o $filho_{direita}$
$(-2,2)$ está, e é retornado.
