...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        \Function{ConstroiArvoreKD}{$P$, $profundidade$}
        ...
        \Else
            ...
            \EndIf
        \EndIf
        \State $v_{esquerda} \leftarrow $ \Call{ConstroiArvoreKD}{$P_1, profundidade+1$}
        \State $v_{direita} \leftarrow $ \Call{ConstroiArvoreKD}{$P_2, profundidade+1$}
    ...
    \Function{BuscaEmArvore}{$v$, $consulta$}
        ...
        \Else
            ...
            \Else
                ...
                \State \Call{BuscaEmArvoreKD(fe(v), Busca)}
                \EndIf
            \EndIf
            ...
            \Else
                ...
                \State \Call{BuscaEmArvoreKD}{$fd(v)$, $consulta$}
                \EndIf
            \EndIf
        \EndIf
    \EndFunction
...
A principal \cite{knuth} comparação realizada é checar se a área de \(Busca\) intersecta a região
