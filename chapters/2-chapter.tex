...
Considera-se os pontos da forma $p = (p_x, p_y)$. Ao iniciar a construção, fixamos o eixo $x$.
Construímos uma árvore binária balanceada considerando considerando os valores na $x$ ordenada. Para cada nó da
árvore, construímos uma árvore binária auxiliar considerando os valores dos pontos ordenados pelo eixo $y$.
...
Para tal, realizamos uma $x$-ordenação nos pontos. Escolhemos o ponto médio $x_{mediana}$ e criamos 
dois subconjuntos P_1 e P_2 tal que:
    $P_1 = \{p \in P : p_x \leq x_{mediana}\}$ e $P_2 = \{p \in P : p_x > x_{mediana}\}$.
Associaremos ao nó uma segunda árvore binária balanceada que construiremos com os pontos de $P$ 
considerando o valor da $y$ ordenada.
...
Sejam os pontos da figura ordenados pelo eixo $x$ = $(15,3),(-4, 5),(2,2),(-2,-2),(3,1),(0,0),(4,-2)
,(3,3),(1,1),(1,2)$
