...
\formacao{Bacharel em Ciencias da Computação}
...
\siglalista{RAM}{Memória de Acesso Aleatório}
\siglalista{V-RAM}{Video RAM}
\siglalista{VSD}{Visible-Surface Determination}
