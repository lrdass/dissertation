...
% ---
\titulo{Algoritmos e estruturas de dados para visualização de polígonos em aplicações de tempo real}
...
\preambulo{Estruturas de dados eficientes para consultas geométricas para aplicações interativas em tempo real. UFSC - Ciências da computação}
% ---
